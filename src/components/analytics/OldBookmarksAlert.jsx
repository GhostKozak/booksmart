    ...
    return (
        <Card className="bg-amber-50/50 dark:bg-amber-950/10 border-amber-200 dark:border-amber-800 lg:col-span-4">
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                <CardTitle className="text-sm font-medium text-amber-800 dark:text-amber-400">{t('analytics.oldAlert.title')}</CardTitle>
            ...
            <CardContent>
                <div className="flex items-center justify-between">
                    ...
                    >
                        {t('analytics.oldAlert.action')} <Link2 className="h-3 w-3" />
                    </Button>
                </div>
            </CardContent>
        </Card>
